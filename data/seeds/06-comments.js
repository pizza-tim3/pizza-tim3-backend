  ...
  return knex("comments")
    ...
    .then(() => {
      return knex("comments").insert([
        ...
        {
          time: `${date}`,
          message: "This is a comment for the second event",
          event_id: 2,
          user_id: "jNpViqXD4DXmf9H2FbkQnAy00000",
        },
        {
          time: `${date}`,
          message: "Im talking to my car now too.  ",
          event_id: 2,
          user_id: "jNpViqXD4DXmf9H2FbkQnAy10000",
        },
        {
          time: `${date}`,
          message: "it puts the mosquitoes on the head...",
          event_id: 2,
          user_id: "jNpViqXD4DXmf9H2FbkQnAy20000",
        },
        {
          time: `${date}`,
          message: "..or it gets the cranky again",
          event_id: 2,
          user_id: "jNpViqXD4DXmf9H2FbkQnAy30000",
        },
        {
